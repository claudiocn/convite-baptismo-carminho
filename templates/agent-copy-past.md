Age segundo as instruções deste `agents.md` que vou colar abaixo e cria um template com um nome "01-drawing-nature" na imagem em anexo.

Aqui está o agents.md:
...
├── images/             # Imagens usadas pelo template
├── sass/
...
## Se possível gera um único batch que se executado cria estes ficheiros e os respectivos conteúdos.
...
4.  **Entrega:** Devolve um batch script que ao executar na raiz do projecto ele cria todos os ficheiros e pastas necessários. Fornece URLs do Google Fonts necessários.
